namespace OutlookPrivacyPlugin
{
    ...
    partial class verificationBar : Microsoft.Office.Tools.Outlook.FormRegionBase
    {
        public verificationBar(Microsoft.Office.Interop.Outlook.FormRegion formRegion)
        ...
        {
            manifest.FormRegionName = "Status";
        ...
        internal System.Windows.Forms.Button status;
        ...
        public partial class FormRegion1Factory : Microsoft.Office.Tools.Outlook.IFormRegionFactory
        {
            ...
            public FormRegion1Factory()
            {
                ...
                verificationBar.InitializeManifest(this._Manifest, Globals.Factory);
            ...
            {
                verificationBar form = new verificationBar(formRegion);
                form.Factory = this;
                return form;
            }
    ...
    {
        internal verificationBar FormRegion1
        {
            get
            {
                foreach (var item in this)
                {
                    if (item.GetType() == typeof(verificationBar))
                        return (verificationBar)item;
                }
                return null;
            }
        }
